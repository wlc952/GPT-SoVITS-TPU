...
class BModel:
    def __init__(self, model_path="", batch=1, device_id=(8,)) :
...
class T2SStage:
    ...
    def __call__(self, x, k_cache, v_cache, current_size):
        ...
        for i in range(24):
            x, ik, iv = self.blocks[i]([x, k_cache[i], v_cache[i], np.int32([current_size])])
        ...
        return x, k_cache, v_cache, current_size + 1
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ssl_path", type=str, default="models/static/00_cnhubert_1684x_f32.bmodel")
    parser.add_argument("--vits_encoder_path", type=str, default="models/static/01_vits_encoder_1684x_f32.bmodel")
    parser.add_argument("--g2pw_path", type=str, default="GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large")
    parser.add_argument("--bert_path", type=str, default="models/static/02_bert_1684x_f32.bmodel")
    parser.add_argument("--t2s_encoder_path", type=str, default="models/static/03_t2s_encoder_1684x_f32.bmodel")
